...
export default async function postDetailPage({ params }: PostIdRouteProps) {
  const { postId } = await params;
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4 animate-in fade-in duration-500 relative">
      <Link
        href="/blog"
        className={buttonVariants({ variant: "secondary", className: "mb-4" })}
      >
      ...
      <p className="text-foreground/90 mt-4 leading-relaxed text-lg whitespace-pre-wrap">
        {post.body}
      </p>
